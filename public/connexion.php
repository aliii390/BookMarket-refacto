...
<body class="bg-[#FDEDD5] min-h-screen flex items-center justify-center">
  <main class="flex flex-col items-center w-full max-w-md px-6 sm:px-8 lg:px-12">
    <form action="../process/connexion-process.php" method="post" class="w-full bg-white p-6 rounded-lg shadow-lg">
      <section class="flex flex-col items-center gap-6">
        ...
        <input
          ...
          class="w-full p-3 border <?php echo isset($_GET['error']) && $_GET['error'] === 'emailoumdpinvalid' ? "border-red-600" : "border-gray-300" ?>  rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 placeholder:font-principale"
          required
        >
