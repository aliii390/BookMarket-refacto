...
<body class="bg-[#FDEDD5]  text-gray-800 font-sans">
  ...
  <?php if ($_SESSION['user']->getRole() === "Vendeur"): ?>
    <section class="mt-10 bg-gray-100 p-6 rounded-lg shadow-md">
      <h2 class="text-lg font-semibold text-gray-800 mb-4">Publier un livre</h2>
      <form action="../process/ajouterLivre.php" method="post" enctype="multipart/form-data" class="space-y-6">
        <div>
          <label for="titre" class="block text-gray-700 mb-1">Titre du livre</label>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <label for="image" class="block text-gray-700 mb-1">Image de couverture</label>
            <input type="file" id="image" name="image" accept="image/*" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400">
          </div>
        </div>
        <button type="submit" class="bg-[#F5702B] text-white px-6 py-2 rounded-lg hover:bg-[#d45920] transition">
          Publier
        </button>
      </form>
    </section>
