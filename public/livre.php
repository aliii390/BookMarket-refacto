...
<main class="p-3 lg:mt-52 ">
  <section class="flex flex-col justify-center items-center lg:flex-row  lg:gap-10 lg:items-center lg:justify-center">
    <!-- Image à gauche -->
    <img src="<?php echo $livre['img_path']; ?>" alt="Livre" class="w-32 sm:w-40 md:w-48 lg:w-64 lg:mr-10">
    
    <!-- Texte et bouton à droite -->
    <article class="flex flex-col items-center lg:items-center  gap-6 ">
