    ...
    <section class="mt-10 bg-gray-100 p-6 rounded-lg shadow-md">
        ...
        <form action="../process/postLivre-process.php" method="post" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="etat_livre" class="block text-gray-700 mb-1 font-principale">Etat du livre</label>
                    <input type="text" id="etat_livre" name="etat_livre" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400">
                </div>
                <div>
                    <label for="auteur" class="block text-gray-700 mb-1 font-principale">Auteur</label>
                    <input type="text" id="auteur" name="auteur" class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-400">
                </div>
                <div>
                    <label for="img_path" class="block text-gray-700 mb-1 font-principale">Image de couverture</label>
