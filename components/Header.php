...
<header class="bg-[#FDEDD5]  flex items-center p-3 justify-between gap-4 sm:justify-between sm:px-6 xl:justify-around ">
  ...
  <div class="hidden md:flex md:ml-6">
    <a href="./inscription.php" class="w-[130px] h-8 bg-[#F5702B] text-white font-principale flex items-center justify-center  hover:bg-[#d45920] transition">
      Connectez-vous
    </a>
  </div>
  ...
  <ul class="list-none p-0 m-0 mt-4 space-y-2">
    ...
    <li class="flex justify-center">
      <a href="./inscription.php" 
        ...
        <span class="font-principale sm:font-principale">Connectez-vous</span>
      </a>
    </li>
  </ul>
</div>
